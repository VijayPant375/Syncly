        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/jobs" className="text-sm text-gray-500 hover:text-primary-600 transition-colors">
                  Browse Jobs
                </Link>
              </li>
              <li>
          ...
          {/* For employers */}
          <div>
            <h3 className="text-sm font-semibold text-gray-900 mb-3">Employers</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/register" className="text-sm text-gray-500 hover:text-primary-600 transition-colors">
                  Post a Job
              ...
              <li>
                <Link to="/employer" className="text-sm text-gray-500 hover:text-primary-600 transition-colors">
                  Employer Dashboard
                </Link>
              </li>
            </ul>
